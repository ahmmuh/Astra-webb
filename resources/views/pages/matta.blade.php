...
<div id="matt-bg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="container text-start ">
            ...
            <div class="row text-start">
                <div class="col-lg-6 col-md-12">
                    <img src="{{url('images/images-shaqo/matt2.jpeg')}}" style="width: 80%; height: 300px"  alt="Bild">
                </div>
            ...
            <div class="row text-start">
                ...
                <div class="col-lg-6 col-md-12">
                        <img src="{{url('images/images-shaqo/matt.jpg')}}" style="width: 80%;"  alt="">
                </div>
            </div>
