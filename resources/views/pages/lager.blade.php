...
<div id="lager-bg" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="container text-start ">
            ...
            <div class="row text-start">
                <div class="col-lg-6 col-md-12">
                    <img src="{{url('images/lager7.jpg')}}" style="width: 80%"  alt="Bild">
                </div>
            ...
            <div class="row text-start">
                ...
                <div class="col-lg-6 col-md-12">
                        <img src="{{url('images/lager2.jpeg')}}" style="width: 80%"  alt="">
                </div>
            </div>
            ...
            <div class="row text-start">
                ...
                <div class="col-lg-6 col-md-12">
                        <img src="{{url('images/lager4.jpeg')}}" style="width: 100%; height: 350px"  alt="">
                </div>
                <div class="col-lg-6 col-md-12">
